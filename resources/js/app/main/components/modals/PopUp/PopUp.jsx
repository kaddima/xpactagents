...
const PopUp = ({
    ...
    outline-none focus:outline-none bg-neutral-800/70">
			<div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 h-full lg:h-auto md:h-auto mx-auto bg-slate-800">
				<div className={`duration-300 h-full ${showModal ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}>
					<div className="p-6 h-full md:h-auto rounded-lg shadow-lg relative space-y-5 flex flex-col justify-center items-center">
						<div>
