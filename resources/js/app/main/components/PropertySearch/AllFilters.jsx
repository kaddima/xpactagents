...
const AllFilters = ({isOpen,onClose}) => {
  ...
  return (
    <div className='fixed inset-0 z-50 bg-neutral-800/10 text-slate-600'>
        <div className={`absolute right-0 w-[90vw] md:w-[45vw] h-full bg-white dark:bg-main-dark-bg  transition ${showAllFilter ? 'translate-x-0' : 'translate-x-[1000px]'} `}>
            <div className='h-16 px-8 py-5'>
                <p className='float-right cursor-pointer' onClick={handleClose}><MdClose size={24}/></p>
                <div className='clear-both'></div>
            </div>
            <div className='h-full-64 overflow-scroll px-2 md:px-0'>
                <div className='border-b dark:border-b-slate-800 pb-6 md:px-8'>
                ...
                {/* PRICE */}
                <div className='py-6 border-b dark:border-b-slate-800 md:px-9'>
                ...
                {/* BEDS/BATHS */}
                <div className='border-b dark:border-b-slate-800 pb-6 md:px-8 py-8'>
                    <BedsNBaths setSearchValues={setSearchValues}/>
                </div>

                {/* STATES */}
                <div className='border-b dark:border-b-slate-800 pb-6 md:px-8 py-8'>
                    <h1 className='text-xl font-semibold'>States/LGAs</h1>
                ...
                <div className='border-b dark:border-b-slate-800 pb-6 md:px-8 py-8'>
                    <div className='mb-2'>
                        <h1 className='text-xl font-semibold'>Home type</h1>
                    </div>
