...
const AllFilters = ({isOpen,onClose}) => {
  ...
  <div className={`absolute right-0 w-[90vw] md:w-[45vw] h-full bg-white transition ${showAllFilter ? 'translate-x-0' : 'translate-x-[1000px]'} `}>
    ...
    <div className='border-b pb-6 md:px-8'>
    ...
    {/* PRICE */}
    <div className='py-6 border-b md:px-9'>
    ...
    {/* BEDS/BATHS */}
    <div className='border-b pb-6 md:px-8 py-8'>
    ...
    <footer className='h-[60px] border'>
