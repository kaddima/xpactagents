...
const PropertySearch = () => {
  ...
  return (
    ...
    <div className="property-search border-[1px] md:w-auto md:py-2 rounded-full shadow-sm hover:shadow-md transition cursor-pointer">
    <div className="flex items-center justify-center">
      <div data-value={'state'} onClick={onSearchNavClick} className="hidden sm:block text-sm font-semibold px-6">
      Anywhere
      </div>
      <div data-value={'bedsbaths'} onClick={onSearchNavClick} className="hidden sm:block text-sm font-semibold px-6 border-x-[1px] flex-1 text-center">
      Rooms
      </div>
      
      <div className="text-sm md:pl-6 md:pr-2 text-gray-600 flex items-center md:gap-3">
      <div data-value={'for'} onClick={onSearchNavClick} className="hidden sm:block font-semibold">
        for sell
      </div>
      
      <div data-value={'allfilters'} onClick={onSearchNavClick} className="p-2 bg-rose-500 rounded-full text-white">
        <BiSearch size={18} />
      </div>
      </div>
    </div>
  ...
  return (
  <div className='property-search w-full bg-white max-w-[850px] mx-auto absolute md:relative z-[800]'>
  <div className='flex items-center justify-between'>
    ...
    <button data-value={'allfilters'} onClick={onSearchNavClick} className='hidden border px-3 h-[2.5rem] rounded md:flex items-center space-x-3 text-sm '>
