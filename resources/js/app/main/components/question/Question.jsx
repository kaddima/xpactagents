  ...
  return (
    <div>
        <div className='mt-5 relative'>  
            <div className='absolute z-[10] inset-0 bg-white transition translate-x-[2000px]' id='q-submitted'>
            ...
            <div className='mt-5'>
                <div >
                    ...
                    <form onSubmit={methods.handleSubmit(onSubmit)} action="" className='relative'>
                        ...
                        <div className='border border-black min-h-[200px] pb-4'>
                            <textarea name="" id="" cols="30" {...methods.register('message',{required:true})} rows="6"className='form-textarea w-full border-0' placeholder='Write a message...' >
                        ...
                        <div className='mt-4 flex items-center gap-5'>
                            <button className='rounded px-5 py-2 bg-black text-white font-semibold'>
                                Ask a question
                            </button>
