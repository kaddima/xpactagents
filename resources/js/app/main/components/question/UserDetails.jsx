                ...
                <div className='space-y-5'>
                    <div className='flex items-center w-full gap-3'>
                        <div className='flex-1'> 
                            ...
                            <input type="text" {...register('first_name',{required:"Please Enter first name"})} className='form-input w-full rounded' placeholder='First name '/>
                        </div>
                        <div className='flex-1'>
                            <label htmlFor="" className='block'>Last name</label>
                            <input type="text" {...register('last_name',{required:"Please Enter last name"})} className='form-input w-full rounded' placeholder='Last name'/>
                        </div>
                    </div>
                    <div className='flex items-center w-full gap-3'>
                        <div className='flex-1'> 
                            <label htmlFor="" className='block'>Email</label>
                            <input type="text" {...register('email',{required:"Please Enter email address"})} className='form-input w-full rounded' placeholder='Email address'/>
                        </div>
                        <div className='flex-1'>
                            <label htmlFor="" className='block'>Phone</label>
                            <input type="text" {...register('phone',{required:"Please Enter phone"})} className='form-input w-full rounded' placeholder='phone'/>
                        </div>
                    </div>
                </div>
