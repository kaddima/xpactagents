...
const VerifyEmail = () => {
	...
	const onResend = () => {
		...
		Axios.post('/register/resend-otp', { email: params.get('email') }).then(data => {
		...
		Axios.post('/register/verify-email',
			{
				...
				if (data.data.data?.is_agent == 1) {
					location.href = '/dashboard'
				} else {
					dispatch(updateUserInfo(data.data.data.user))
		...
		<div className='w-full h-full'>
			...
			<div className='max-w-[400px] mx-auto px-3 md:px-0'>
				<div className='w-full'>
					...
					<div className='py-3 border-b dark:border-b-slate-800 text-center mb-5'>
