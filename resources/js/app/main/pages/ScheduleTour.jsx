        ...
        <form action="">
            <div className='space-y-5'>
                ...
                <div>
                    ...
                    <input type="text" {...register('first_name', {required:"Please provide first name"})} className='form-input border dark:bg-transparent rounded block w-full' placeholder='John'/>
                ...
                <div>
                    ...
                    <input type="text" {...register('last_name', {required:"Please provide second name"})} className='form-input border dark:bg-transparent rounded block w-full' placeholder='Doe'/>
                ...
                <div>
                    ...
                    className='form-input border dark:bg-transparent rounded block w-full' placeholder='(+234) 902 -4567-233'/>
                    {errorState.phone && (
                ...
                <div>
                    ...
                    <textarea name="" id="" {...register('notes')} className='w-full form-textarea dark:bg-transparent' placeholder='Are there other times that could work for a tour? We could get you confirmed faster.'>
                ...
                <div>
                    ...
                    <div className='flex items-center space-x-5 mt-3'>
                        <div>
                            <input type="radio" id='email' {...register('best_contact')} name='best_contact' className='h-5 w-5 form-radio dark:bg-transparent' value={'email'} />
                            <label htmlFor="email" className='inline-block pl-2'>Email</label>            
                        </div>
                        <div>
                            <input type="radio" id='call' {...register('best_contact')} name='best_contact' className='h-5 w-5 form-radio dark:bg-transparent' value={'call'}/>
                            <label htmlFor="call" className='inline-block pl-2'>Call</label>
                            
                        </div>
                        <div>
                            <input type="radio" id='text' {...register('best_contact')} name='best_contact' className='h-5 w-5 form-radio dark:bg-transparent' value={'text'}/>
