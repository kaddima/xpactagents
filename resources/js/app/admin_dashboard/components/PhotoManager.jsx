...
const PhotoManager = ({propertyDetails,images=[],
    ...
    const deleteImage = (v)=>{
        ...
        const data = {creator_id:propertyDetails?.creator_id,property_id:propertyDetails?.id,image:v}
        ...
        <div className='md:w-11/12 h-full mx-auto  bg-white dark:bg-slate-900 rounded md:rounded-2xl overflow-hidden pb-7'>
            ...
            <div className='md:flex gap-3 w-full pt-7 px-3 md:px-7 h-[calc(100%-64px)] overflow-scroll'>
                <div className='max-w-[250px] space-y-2'>
                    ...
                    <ImageUpload property_id={propertyDetails?.id} getPhoto={true} fn={setFn}/>
                </div>
