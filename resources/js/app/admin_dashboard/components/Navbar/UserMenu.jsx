  ...
  return (
    <div className='relative' id='userMenu'>
        ...
        {isOpen && (
            ...
            <div className="absolute z-[700] bg-white dark:bg-slate-950 md:h-[450px] rounded-xl shadow-md w-[90vw] md:w-[250px] overflow-scroll right-0 top-12 text-sm">
                <div className="flex flex-col cursor-pointer">
                    
                    <MenuItem onClick={()=>{
                        navigate(`${currentUser?.profile_complete == 1 ? '#' : '/admin/account/complete-registration'}`)    
                        toggleOpen()}} 
                        icon={<FaSignal/>}
