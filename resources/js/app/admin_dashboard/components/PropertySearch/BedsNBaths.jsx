        ...
        <div>
            ...
            <div className='flex'>
                 {['any',1,2,3,4,5].map((v,i)=>{
                    ...
                    return (<button key={i} onClick={onBedBathClick} data-value={v} data-action="beds" className={`${v == value.beds ? 'bg-[#2d8997] text-white font-semibold' : ''} flex-1 capitalize border dark:border-slate-800 py-[8px] px-[0.5rem] 
        ...
        <div className='mt-5'>
            ...
            <div className='flex'>
                 {['any',1,2,3,4,5].map((v,i)=>{
                    ...
                    return (<button key={i} onClick={onBedBathClick} data-value={v} data-action='baths' className={`${v == value.baths ? 'bg-[#2d8997] text-white font-semibold' : ''} flex-1 capitalize border dark:border-slate-800 py-[8px] px-[0.5rem] 
