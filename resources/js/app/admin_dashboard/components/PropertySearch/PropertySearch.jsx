...
const PropertySearch = () => {
  ...
  return (
    <div className='property-search w-full   max-w-[850px] mx-auto relative z-[800]'>
        <div className='flex items-center'>
            <div className='flex items-center space-x-3'>
                <div className='hidden md:flex flex-col max-w-[150px] '>
                    ...
                    <div className={`${searchNav == 'for' ? 'block' : 'hidden'} relative w-0 h-0 overflow-visible z-[800] cursor-auto`}>
                        <div className='p-0 pb-[1rem] bg-white dark:bg-slate-950 absolute top-0 left-0 shadow-[-0.8px_0.25px_3px_2.5px_rgba(0,0,0,.15)]   
                ...
                <div className='hidden md:flex flex-col max-w-[150px]'>
                    ...
                    <div className={`${searchNav == 'price' ? 'block' : 'hidden'} relative w-0 h-0 overflow-visible z-[800] cursor-auto`}>
                        <div className='p-0 pb-[1rem] absolute bg-white dark:bg-slate-950 top-0 left-0 shadow-[-0.8px_0.25px_3px_2.5px_rgba(0,0,0,.15)]   
                        leading-[1.25] rounded-[5px] mt-[0.5em] w-[371px] max-h-[620px]'>
                ...
                <div className='hidden md:flex flex-col max-w-[150px]'>
                    ...
                    <div className={`${searchNav == 'hometype' ? 'block' : 'hidden'} relative w-0 h-0 overflow-visible z-[800] cursor-auto left-[100%]`}>
                        <div className='p-0 pb-[1rem] absolute bg-white dark:bg-slate-950 top-0 right-0 shadow-[-0.8px_0.25px_3px_2.5px_rgba(0,0,0,.15)]   
            ...
            <div className=' max-w-[150px] ml-5'>
                <div className='flex gap-2 items-center'>
                    ...
                    <button data-value={'allfilters'} onClick={onSearchNavClick} className='border dark:border-slate-800 px-3 h-[2.5rem] rounded hidden md:flex items-center space-x-3 text-sm '>
                        <TbChartCandle size={24} className='text-slate-600'/>
                        <span>All Filters </span>
                    </button>
                    <button onClick={()=>{setSearchParams({})}} title='Reset search' className='border dark:border-slate-800 px-3 h-[2.5rem] rounded flex items-center space-x-3 text-sm '>
