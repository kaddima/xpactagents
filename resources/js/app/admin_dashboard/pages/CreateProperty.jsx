                            ...
                            <div className='w-full md:w-3/5'>
                                <div className='text-sm space-y-5 px-2'>
                                    ...
                                    <div className='max-h-[350px] overflow-hidden'>
                                        ...
                                        <div className='mb-2'>
                                            ...
                                            <ul className='text-xs list-disc ml-4'>
                                                ...
                                                <li>You can choose to upload an image later on the property <Link to={`/admin/listings/${propertyID}/edit`} className='text-blue-400'>edit page</Link> </li>
                                            </ul>
                                        </div>
                                            <ImageUpload property_id={propertyID} />  
                                        </div>) : 
                                        (<div className='h-[150px] flex flex-col justify-center rounded-lg border border-black dark:border-slate-800 border-dashed'>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" {...register('name',{ required:"Name of listing must be filled  "})} className='form-input bg-transparent border w-full dark:border-slate-800' placeholder='Property name' 
                                         />
                                        {errors.name && (
                                ...
                                <div>
                                    ...
                                    <div className='space-y-3'>
                                        ...
                                        <div>
                                            ...
                                            <input type="datetime-local" {...register("property_fact.upload_time")} className='form-input bg-transparent border w-full dark:border-slate-800 '/>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className='flex items-center w-full space-x-2'>
                                                <div className='w-[60%] flex-1'>
                                                    <input type="number" {...register('property_fact.property_size',{required:"Please provide property size"})} className='form-input bg-transparent border w-full dark:border-slate-800' placeholder='Enter property size'/>
                                                </div> 
                                                <div className='w-[40%] flex-1'>
                                                    <input list='unit' name='property_type' {...register("property_fact.unit",{required:"Please provide unit"})} type='text' className='form-input bg-transparent border w-full dark:border-slate-800' placeholder='Enter Measurement'/>
                                        ...
                                        {property_category != 'land' && <>
                                            <div>
                                                ...
                                                <input type="text" {...register('property_fact.flooring')} className='form-input bg-transparent border w-full dark:border-slate-800 '/>
                                            </div>
                                        </>}
