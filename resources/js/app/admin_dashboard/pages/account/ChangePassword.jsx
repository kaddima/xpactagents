			...
			<div className=' w-full p-5'>
				...
				<form className='mt-4 text-sm font-semibold space-y-3' onSubmit={handleSubmit(onSubmitForm)}>
                    <div className=''>
						...
						minLength:{value:6,message:"Password too short"} })}  className={`form-input rounded-md placeholder:text-gray-400 placeholder:text-sm border-slate-300 dark:border-slate-800 dark:bg-transparent mt-1 pl-2 w-full `}
                    ...
                    <div className=''>
						...
						})}  className={`form-input rounded-md placeholder:text-gray-400 placeholder:text-sm border-slate-300 dark:border-slate-800 dark:bg-transparent mt-1 pl-2 w-full `}
