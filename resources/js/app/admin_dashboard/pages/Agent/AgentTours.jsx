	...
	return (
		<tr className='py-3'>
			...
			<td className='text-center border-b-1 border-b-gray-300'>
				<span className='text-sm text-center block text-gray-600'>{data.first_name} {data.last_name}</span>
			</td>
			<td className='text-center border-b-1 border-b-gray-300'>
				<span className='text-sm text-center block text-gray-600'>{data.phone}</span>
			</td>
			<td className='text-center border-b-1 border-b-gray-300'>
				<span className='text-sm text-center block text-gray-600'>{data.date && format(parseISO(data.date), 'eee, dd MMM Y')}</span>
			</td>
			<td className='text-center border-b-1 border-b-gray-300'>
...
const AgentTours = () => {
	...
	useEffect(() => {
		Axios.get(`/admin/agents/${agent_id}/tours`).then((data) => {
