...
const Card = ({icon,name,number})=>{
    ...
    return   <div className='bg-neutral-100 dark:bg-slate-900 rounded-lg p-2 w-full'>
...
const AgentOverview = () => {
    ...
    useEffect(()=>{
        Axios.get('/agents/general-data', {params:{agent_id}}).then(data=>{
        ...
        <div className=''>
            ...
            <div className='flex flex-col gap-3 md:flex-row'>
                <div className='md:w-2/4'>  
                    <div className='relative gap-2 md:gap-5 flex items-center w-full border bg-[#ff6746] rounded-xl p-3'>
                ...
                <div className='md:w-2/4'>
                    {/* TOUR REQUEST */}
                    <div className='w-full bg-neutral-100 dark:bg-slate-900 rounded-xl p-2 h-full'>
                            ...
                            <div className='mt-2'>
                                ...
                                <div className='h-[calc(100%-3rem)] flex items-center justify-center'>
                                    <div className='text-center'>
                                        <div className='flex items-center justify-center w-16 h-16 mx-auto rounded-full bg-neutral-200'>
