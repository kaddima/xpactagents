...
const Agents = () => {
    ...
    const [agentsDetails, setAgentsDetails] = useState({data:[]})
        ...
        <div>
            ...
            <div className='mt-5 overflow-x-scroll'>
                ...
                <table className='w-full table-auto text-black dark:text-slate-400'>
                    ...
                    {(agentsDetails && (agentsDetails?.links.length - 2) > 1) ? (<div className='flex gap-1 items-center float-right'>
                        {agentsDetails?.links.map((v,i,arr)=>{
