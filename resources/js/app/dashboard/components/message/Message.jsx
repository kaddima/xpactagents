...
const Message = () => {
  ...
  <div className='bg-white w-full h-full overflow-hidden '>
    <div className='h-full md:flex'>
      <div className={`${activeUser && 'hidden md:block'}  bg-neutral-50 h-full w-[90%] md:w-[200px] space-y-5 py-2 overflow-scroll`}>
        <h1 className='text-xs text-slate-500 uppercase font-bold pb-3 mb-3 px-2 border-b'>Interested users</h1>
      ...
      <div className='flex-1 relative'>
        ...
        {conversation_id && messages.length > 0 && <div className='flex w-full h-full'>
          ...
          <div onClick={()=>setShowUserProfile(prev=>!prev)} className={`${showUserPofile ? 'translate-x-0' : 'translate-x-[200px] md:translate-x-0'} transition right-0 cursor-pointer absolute w-[200px] bg-neutral-50 md:relative`}>
            <UserProfile activeUserInfo={activeUserInfo}/>
            <div className='h-[30px] bg-white shadow-md w-[20px] md:hidden rounded-tl-full text-sky-600 rounded-bl-full absolute top-2/4 -left-4 flex items-center'>
