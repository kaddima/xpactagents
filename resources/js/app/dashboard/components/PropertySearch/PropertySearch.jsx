  ...
  return (
    <div className='property-search w-full   max-w-[850px] mx-auto relative z-[800]'>
        <div className='flex items-center'>
            ...
            <div className='flex flex-col max-w-[150px] ml-5'>
                <div data-value={'allfilters'} onClick={onSearchNavClick} className="block md:hidden p-1 bg-rose-500 rounded-full text-white">
                    <BiSearch size={18} />
                </div>
