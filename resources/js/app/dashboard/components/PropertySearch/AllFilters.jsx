...
const AllFilters = ({isOpen,onClose}) => {
  ...
  <div className='fixed inset-0 z-50 bg-neutral-800/10 text-slate-600'>
    <div className={`absolute right-0 w-[90%] md:w-[45vw] h-full bg-white transition ${showAllFilter ? 'translate-x-0' : 'translate-x-[1000px]'} `}>
      ...
      <div className='h-full-64 overflow-scroll'>
        <div className='border-b pb-6 px-2 md:px-8'>
        ...
        {/* PRICE */}
        <div className='py-6 border-b px-2 md:px-9'>
        ...
        {/* BEDS/BATHS */}
        <div className='border-b pb-6 px-2  md:px-8 py-8'>
