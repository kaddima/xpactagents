...
const AllFilters = ({isOpen,onClose}) => {
    ...
    /** Handles closing the all filter component */
    ...
    const onSearch = ()=>{
        ...
        //close the all filter component
        handleClose()
        ...
        navigate(`/dashboard/listings/search${queryStr}`)
  ...
  return (
    <div className='fixed inset-0 z-50 bg-neutral-800/10 text-slate-600'>
        <div className={`absolute bg-white dark:bg-slate-900 right-0 w-[90%] md:w-[45vw] h-full   transition ${showAllFilter ? 'translate-x-0' : 'translate-x-[1000px]'} `}>
            ...
            <div className='h-full-64 overflow-scroll'>
                <div className='border-b dark:border-b-slate-700 pb-6 px-2 md:px-8'>
                ...
                {/* PRICE */}
                <div className='py-6 border-b dark:border-b-slate-700 px-2 md:px-9'>
                ...
                {/* BEDS/BATHS */}
                <div className='border-b dark:border-b-slate-700 pb-6 px-2  md:px-8 py-8'>
