				...
				<div className='mt-2 space-y-3 overflow-auto'>
					...
					<div className="hover:opacity-80 ">
						<NavLink
							...
							`flex space-x-2 items-center bg-theme-color transition-all text-white py-3 pl-5 
							text-sm font-semibold hover:opacity-95 relative dark:bg-slate-800` : 
							`flex space-x-2 items-center bg-theme-color transition-all text-white py-3 pl-5 
							text-sm font-semibold hover:opacity-95 relative`}
						>
