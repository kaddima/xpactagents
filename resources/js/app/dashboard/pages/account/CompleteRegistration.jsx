...
const CompleteRegistration = () => {
	...
	const onSubmitForm = (data) => {
		...
		Axios.put('/users/complete-profile', data).then((data) => {
	...
	return (
		...
		<div className="py-10   rounded shadow">
			<div className="">
									...
									<div className="flex flex-col md:flex-row gap-3">
										<div className="flex gap-2 items-center">
											<input type="radio" name="gender" {...register('gender', { required: "Please choose a gender" })} value="male" id="male"
												className="block dark:bg-transparent dark:border-slate-800 border form-radio w-5 h-5" />
