...
const Profile = () => {
  ...
  // const user_id = 1
  // const userDetails = useSelector(state=>state.account.user.profile)
  // const accountDetails = useSelector(state=>state.account.user.account)
  // const cardDetails = useSelector(state=>state.account.user.card)
  // const [inputData, setInputData] = useState({});

  // const [profileEditShow,setProfileEditShow] = useState(false)

  // const profile_account_details = {...userDetails, ...accountDetails, ...cardDetails}

  const dispatch = useDispatch()  
  // const handleEditClick = (e)=>{
  //   //get the name of the info to edit
  ...
  //  name==='cvc' || name==='card_numer'){
  //   formType = 'number'
  //   }

  //   let data = {name,value:profile_account_details[name],formType}
  ...
  //   $('#spinner').fadeIn()
  //   //get the card status
  //   let card_active = cardDetails.card_active
  //   let data = {user_id,name:"card_active", value: (card_active == 1) ? 0 : 1}

  //   axios.post('/admin/update-user', data).then(data=>{
    
  //   $('#spinner').fadeOut()
  //   toast(`Card is ${(card_active == 1) ? 'Deactivated' : 'Activated'}`)
  ...
  return (
  <div className='bg-white md:h-full text-gray-500 md:p-5 p-2 md:overflow-auto'>
