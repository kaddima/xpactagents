...
const CreateProperty = () => {
    ...
    const initialValue = {
        ...
        toilets:'',
        property_category:'',
        property_fact:{unit:'sq.ft',property_size:0,upload_time:new Date().toString()}
    }
    const {register,handleSubmit,watch,formState:{errors}} = useForm({defaultValues:initialValue})
    ...
    const submitForm = (data)=>{
        ...
        let values = {...data,description:descriptionValue,property_id:propertyID,creation_type,amenities}

        Axios.post('/dashboard/create-property',values).then(data=>{
                            ...
                            <div className='w-full md:w-3/5'>
                                <div className='text-sm space-y-5 px-2'>
                                    ...
                                    <div className='max-h-[350px] overflow-hidden'>
                                        ...
                                        <div className='mb-2'>
                                            ...
                                            <ul className='text-xs list-disc ml-4'>
                                                ...
                                                <li>You can choose to upload an image later on the property <Link to={`/dashboard/property/${propertyID}/edit`} className='text-blue-400'>edit page</Link> </li>
                                            </ul>
                                        </div>
                                            <ImageUpload property_id={propertyID} />  
                                        </div>) : 
                                        (<div className='h-[150px] flex flex-col justify-center rounded-lg border-[2px] border-orange-600 border-dashed'>
                                            <div className=''>
                                                <MdHourglassEmpty size={32} className='mx-auto'/>
                                                <ul className='text-xs list-disc ml-4'>
                                                    <li>To upload an image for the property first fill in the required fields</li>
                                                    <li>Thereafter click on the <span className='text-orange-400 font-semibold'>"Create"</span> button to create your listings</li>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" {...register('name',{ required:"Name of listing must be filled  "})} className='form-input bg-transparent  border w-full' placeholder='Property name' 
                                         />
                                        {errors.name && (
                                    ...
                                    <div>
                                        ...
                                        <input type="number" {...register('amount')} className='form-input bg-transparent border w-full' placeholder='Amount' 
                                         />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" {...register('address')}  className='form-input bg-transparent border w-full' placeholder='Address'
                                         />
                                    </div>

                                    <div>
                                        <label htmlFor="" className='block'>Property category</label>
                                        <select name="property_category" {...register('property_category',{required:"Please choose the property category"})}  className='form-select bg-transparent border w-full'    >
                                    ...
                                    <div>
                                        ...
                                        <select name="property_category" {...register('other_category',{required:"Please choose the property category"})} defaultValue={'any'}  className='form-select bg-transparent border w-full'>
                                    ...
                                    {(property_category !== 'land' && property_category !== 'sell') && (
                                        <div>
                                            ...
                                            <select name="duration" {...register('duration')} className='form-select bg-transparent border w-full'  >
                                    ...
                                    <div>
                                        ...
                                        <input list='property-type' name='property_type' {...register("property_type",{ required:"Property type must be filled  "})} type='text' className='form-input bg-transparent border w-full '/>
                                    ...
                                    <div className='flex justify-between items-center'>
                                        <div>
                                            ...
                                            <select name="bedrooms" {...register('bedrooms')} className='form-select bg-transparent border w-full' 
                                              >
                                        ...
                                        <div>
                                            ...
                                            <select name="bathrooms" {...register('bathrooms')} className='form-select bg-transparent border w-full'    >
                                        ...
                                        <div>
                                            ...
                                            <select name="toilets" {...register('toilets')}  id="" className='form-select bg-transparent border w-full'    >
                                    ...
                                    <div>
                                        ...
                                        <div className={`fixed bottom-5 right-5 text-sm `}>
                                            <div className='flex items-center gap-3'>
                                                <button disabled={propertyID ? true : false} type='submit' className='disabled:cursor-not-allowed disabled:bg-theme-color/60 bg-theme-color text-white py-2 px-4 rounded'>
                                                    Create
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div className='space-y-3'>
                                        {property_category != 'land' && <>
                                            <div>
                                                ...
                                                <input type="number" {...register("property_fact.year_built")} className='form-input bg-transparent border rounded w-full'/>
                                            </div>
                                        </>}
                                        
                                        <div>
                                            <label htmlFor="">Time on Xpact Agent</label>
                                            <input type="datetime-local" {...register("property_fact.upload_time")} className='form-input bg-transparent border w-full '/>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className='flex items-center w-full space-x-2'>
                                                <div className='w-[60%] flex-1'>
                                                    <input type="number" {...register('property_fact.property_size',{required:"Please provide property size"})} className='form-input bg-transparent border w-full' placeholder='Enter property size'/>
                                                </div> 
                                                <div className='w-[40%] flex-1'>
                                                    <input list='unit' name='property_type' {...register("property_fact.unit",{required:"Please provide unit"})} type='text' className='form-input bg-transparent border w-full' placeholder='Enter Measurement'/>
                                            ...
                                            <p className="text-red-400 text-xs">{errors.property_fact?.property_size.message}</p>
                                            )}
                                            {errors.property_fact && (
                                            <p className="text-red-400 text-xs">{errors.property_fact.unit?.message}</p>
                                            )}
                                        </div>
                                        {property_category != 'land' && <>
                                            <div>
                                                <label htmlFor="">Flooring (tiles,wood,)</label>
                                                <input type="text" {...register('property_fact.flooring')} className='form-input bg-transparent border w-full '/>
                                            </div>
                                        </>}
