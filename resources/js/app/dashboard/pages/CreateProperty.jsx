                            ...
                            <div className='w-full md:w-3/5'>
                                <div className='text-sm space-y-5 text-slate-600 px-2'>
                                    ...
                                    <div className='max-h-[350px] overflow-hidden'>
                                        ...
                                        (<div className='h-[150px] flex flex-col justify-center rounded-lg border border-black border-dashed'>
                                            <div className='text-center '>
                                                <MdHourglassEmpty size={32} className='mx-auto'/>
                                                <p>You can upload an image after first creating a property</p>
                                            </div>
                                        </div>)}
