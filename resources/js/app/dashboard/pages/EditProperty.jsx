                                        ...
                                        <div>
                                            ...
                                            <div className='flex items-center w-full space-x-2'>
                                                <div className='w-[60%] flex-1'>
                                                    <input type="number" {...register('property_fact.property_size')} className='form-input bg-transparent border w-full dark:border-slate-800' placeholder='Enter property size'/>
                                                </div> 
                                                <div className='w-[40%] flex-1'>
                                                    <input list='unit' name='property_type' {...register("property_fact.unit")} type='text' className='form-input bg-transparent border w-full dark:border-slate-800' placeholder='Enter Measurement'/>
