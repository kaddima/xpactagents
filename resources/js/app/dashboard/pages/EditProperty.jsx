        ...
        <div className='w-11/12 mx-auto'>
            <div className=''>
                <div className='pt-5 md:flex justify-between items-center'>
                    ...
                    <button onClick={()=>onPublished(propertyDetails.id)} className={`border-[2px] ${propertyDetails.published == 1 ? 'border-green-600' : 'border-red-600'} text-xs px-5 transition py-2 rounded-md hover:bg-theme-color hover:text-white mt-3 md:mt-0`}>
                        ...
                        <div className='h-full flex space-x-1 relative'>
                            <div className='md:w-2/4 overflow-hidden rounded-tl-lg rounded-bl-lg'>
                                {(propertyDetails?.images && propertyDetails?.images.length) ? (
                                    <img src={`/uploads/users/${currentUser.id}/${propertyDetails.images[0]}`} alt="" className='h-[22rem] w-full object-cover'/>)
                                    :
                            ...
                            <div className='w-2/4 md:flex hidden space-x-1 overflow-hidden rounded-tr-lg rounded-br-lg'>
                                ...
                                {(propertyDetails?.images && propertyDetails?.images.length) > 1 ? (
                                    <img src={`/uploads/users/${currentUser.id}/${propertyDetails.images[1]}`} alt="" className='h-[22rem] w-full object-cover'/>)
                                    :
                                ...
                                {(propertyDetails?.images && propertyDetails?.images.length) > 2 ? (
                                    <img src={`/uploads/users/${currentUser.id}/${propertyDetails.images[2]}`} alt="" className='h-[22rem] w-full object-cover'/>)
                                    :
                                        ...
                                        <div>
                                            ...
                                            <div className='flex items-center w-full space-x-2'>
                                                <div className='w-[60%] flex-1'>
                                                    <input type="number" {...register('property_fact.property_size')} className='form-input bg-transparent border w-full' placeholder='Enter property size'/>
                                                </div> 
                                                <div className='w-[40%] flex-1'>
                                                    <input list='unit' name='property_type' {...register("property_fact.unit")} type='text' className='form-input bg-transparent border w-full' placeholder='Enter Measurement'/>
